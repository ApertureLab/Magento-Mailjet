...
/**
 * Class AL_Mailjet_Model_Observer
 *
 * Event handlers
 */
class AL_Mailjet_Model_Observer
{
    ...
    public function beforeBlockToHtml(Varien_Event_Observer $observer)
    {
        ...
        if ($grid instanceof Mage_Adminhtml_Block_Newsletter_Subscriber_Grid) {
            ...
            $grid->addColumnAfter('mailjet_status', array(
                ...
                'width'     => '95px',
                'renderer'  => new AL_Mailjet_Block_Adminhtml_Newsletter_Renderer_Status(),
                'filter'    => false,
                'sortable'  => false,
            ), 'store');
        }
     ...
     *
     * @param Varien_Event_Observer $observer
     * @return AL_Mailjet_Model_Observer
     */
    public function updateCustomer(Varien_Event_Observer $observer)
    {
        ...
        $mjLists = Mage::getModel('al_mailjet/api_lists');
        /* @var $mjLists AL_Mailjet_Model_Api_Lists */
    ...
    public function updateSubscriberStatusDate(Varien_Event_Observer $observer)
    {
        ...
        Mage::helper('al_mailjet')->logDebug('Update date: ' . $date->toString('yyyy-MM-dd HH:mm:ss')); // debug
